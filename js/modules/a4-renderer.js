(function () {
  ...
  function documentStyles() {
    return `
      ...
      .bgps-a4-layout-worksheet .bgps-a4-page-body{font-size:10.6pt;line-height:1.42}.bgps-a4-question-card{margin:0 0 3mm;padding:3mm 4mm;border:.25mm solid #cfdae6;border-radius:2.2mm;background:#fff;break-inside:avoid;page-break-inside:avoid}.bgps-a4-question-card.bgps-a4-continued-block{border-top-style:dashed}.bgps-a4-question-card>.question-line:first-child{margin-top:0;color:#173c67;font-weight:800}
