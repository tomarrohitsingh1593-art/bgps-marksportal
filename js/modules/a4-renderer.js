(function () {
  ...
  function documentStyles() {
    return `
      ...
      html,body{margin:0;padding:0;background:#fff;color:#000;font-family:"Noto Sans Devanagari","Nirmala UI","Mangal","Segoe UI",Arial,sans-serif;font-weight:500;-webkit-font-smoothing:auto;text-rendering:optimizeLegibility;-webkit-print-color-adjust:exact;print-color-adjust:exact}
      ...
      .bgps-a4-header{flex:0 0 auto;color:#000}.bgps-a4-first-header{padding:5mm 6mm 4mm;border:.55mm solid #000;border-radius:3mm;background:#fff;text-align:center;margin-bottom:4mm}
      .bgps-a4-first-header h1{margin:0;font-family:Georgia,"Noto Serif Devanagari",serif;font-size:19pt;line-height:1.05;letter-spacing:1pt}.bgps-a4-first-header h2{margin:2mm 0 1.8mm;color:#000;font-size:12.5pt;line-height:1.2}
      .bgps-a4-header-rule{height:.25mm;margin:0 0 2mm;background:#000}.bgps-a4-meta{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:1.7mm 5mm;text-align:left;font-size:9pt}.bgps-a4-meta span{white-space:normal}.bgps-a4-meta span:nth-child(4n+3),.bgps-a4-meta span:nth-child(4n+4){text-align:right}
      .bgps-a4-student-lines{display:flex;justify-content:space-between;gap:8mm;margin-top:2.5mm;font-size:9pt}.bgps-a4-instructions{margin-top:2.5mm;padding:1.8mm 2.5mm;border:.3mm solid #000;border-radius:1.5mm;background:#fff;text-align:left;font-size:8.5pt}.bgps-a4-instructions ol{margin:1mm 0 0 5mm;padding:0}
      .bgps-a4-continuation-header{display:flex;justify-content:space-between;gap:8mm;border-bottom:.4mm solid #000;padding-bottom:1.8mm;margin-bottom:3mm;color:#000;font-size:8.8pt}
      ...
      .bgps-a4-layout-worksheet .bgps-a4-page-body{font-size:10.6pt;line-height:1.42}.bgps-a4-question-card{margin:0 0 2.8mm;padding:0;border:0!important;border-radius:0!important;background:transparent!important;box-shadow:none!important;break-inside:avoid;page-break-inside:avoid}.bgps-a4-question-card.bgps-a4-continued-block{padding-top:1mm}.bgps-a4-question-card>.question-line:first-child{margin-top:0;color:#000;font-weight:800}
      ...
      .bgps-a4-page-body .question-line{display:block;position:relative;padding-right:13mm;font-weight:700;break-inside:avoid;page-break-inside:avoid}.bgps-a4-page-body .mark-token{float:right;min-width:10mm;margin-left:2mm;color:#000;text-align:right;font-weight:900;white-space:nowrap}
      .bgps-a4-page-body .section-heading{display:flex;justify-content:space-between;gap:5mm;margin:3mm 0 1.8mm;padding:1.8mm 2.5mm;border:.35mm solid #000;border-radius:1.4mm;background:#fff;color:#000;font-weight:800}
      .bgps-a4-layout-formal .bgps-a4-page-body .question-line{border-bottom:.18mm solid #555;padding-bottom:1mm;margin-top:2.2mm}.bgps-a4-layout-formal .bgps-a4-page-body .question-line:last-child{border-bottom:0}
      .bgps-a4-page-body table{width:100%;max-width:100%;border-collapse:collapse;margin:2mm 0;break-inside:avoid}.bgps-a4-page-body td,.bgps-a4-page-body th{border:.3mm solid #000;padding:1.6mm}.bgps-a4-page-body th{background:#fff}
      ...
      .bgps-a4-page-body .bgps-match-block,.bgps-a4-page-body .bgps-match-row{clear:both;break-inside:avoid;page-break-inside:avoid}.bgps-a4-page-body table.bgps-match-table{table-layout:fixed}.bgps-a4-page-body .bgps-match-table th,.bgps-a4-page-body .bgps-match-table td{width:50%;vertical-align:middle}.bgps-a4-page-body .bgps-match-index,.bgps-a4-page-body .bgps-match-label{display:inline-block;margin-right:1.5mm;font-weight:900}.bgps-a4-page-body .bgps-match-image{display:inline-block!important;float:none!important;clear:none!important;max-width:calc(100% - 9mm)!important;margin:1mm auto!important;vertical-align:middle}.bgps-a4-page-body .bgps-match-image-placeholder{display:inline-flex;align-items:center;justify-content:center;width:calc(100% - 9mm);min-height:18mm;border:.3mm dashed #777}
      ...
      .bgps-a4-page-body .answer-line{display:inline-block;min-width:32mm;border-bottom:.4mm solid #000}.bgps-a4-page-body .answer-box{display:inline-block;min-width:9mm;min-height:7mm;border:.3mm solid #000;border-radius:1mm}.bgps-a4-scale-to-page{max-height:100%;overflow:hidden;font-size:85%}
      .bgps-a4-footer{display:flex;justify-content:space-between;gap:5mm;flex:0 0 auto;border-top:.25mm solid #000;padding-top:1.6mm;margin-top:2mm;color:#000;font-size:7.6pt}
      .${PAGE_CLASS},.${PAGE_CLASS} *{color:#000!important;text-shadow:none!important}
      @media print{.${DOCUMENT_CLASS}{display:block;background:#fff;padding:0;gap:0}.${PAGE_CLASS}{margin:0;box-shadow:none}.${PAGE_CLASS},.${PAGE_CLASS} *{color:#000!important;-webkit-print-color-adjust:exact!important;print-color-adjust:exact!important}}
    `;
  }
